...
const handleAddExpense = (assignment) => {
    setSelectedExpenseAssignment(assignment);
  ...
  const [selectedAssignmentNames, setSelectedAssignmentNames] = useState([
    "All",
  ]);
  ...
  const filteredAssignments = useMemo(() => {
    ...
    const matchesSearch = (assignment) => {
      return (
        ...
        (assignment.functions || []).some((f) =>
          f.functionName?.toLowerCase().includes(text)
        ) ||
        (assignment.transactions || []).some((t) =>
  ...
  const submitPayment = async () => {
    ...
    try {
      await axios.put(
        `${config.BASE_URL}order/assignment/${paymentAssignment.id}`,
        {
          ...paymentAssignment,
      ...
      await axios.post(
        `${config.BASE_URL}order/assignment/${paymentAssignment.id}/transaction`,
        {
          receivedPayment: 0,
  ...
  const getTitleText = () => {
    switch (timeFilter) {
      ...
      case "LastMonth":
        ...
        const curr_year = currentDate.toLocaleString("default", {
          year: "numeric",
        });
      ...
      case "LastYear":
        const current_year = currentDate.toLocaleString("default", {
          year: "numeric",
        });
  ...
  return (
    <div>
            ...
            >
              ...
              <div className="px-4">
                <div style={{ display: "flex", justifyContent: "center" }}>
                  ...
                  >
                    <DatePicker
                      ...
                      dayClassName={(date) =>
                        hasAssignmentOnDate(date) ? "has-assignment" : undefined
                      }
                    />
                  </div>
                </div>
                ...
                {uniqueAssignmentNames.map((name, idx) => (
                  <div
                    key={idx}
                    className="form-check mb-3 ms-3 d-flex align-items-center gap-2"
                  >
                    <input
                      className={`form-check-input`}
                      type="checkbox"
                      ...
                      style={{
                        backgroundColor: selectedAssignmentNames.includes(name)
                          ? `var(--bs-${assignmentColorMap.get(
                              normalize(name)
                            )})`
                          : "transparent",
                        borderColor: `var(--bs-${assignmentColorMap.get(
                          normalize(name)
                        )})`,
                      }}
                    />
                    ...
                    {[...filteredAssignments]
                      ...
                      .map((assignment, index) => {
                        ...
                        return (
                          <div
                            key={index}
                            className="border border-top-0 border-start-0 border-end-0 rounded p-3 pb-4 d-flex gap-4"
                            style={{}}
                          >
                            {/* Date Column */}
                            <div
                            ...
                            <div className="flex-grow-1">
                              ...
                              <div className="text-muted small">
                                ...
                                <strong>
                                  <span
                                    className={`badge bg-${
                                      assignmentColorMap.get(
                                        normalize(assignment.assignmentName)
                                      ) || "secondary"
                                    }`}
                                  >
                            ...
                            >
                              <div className="d-flex gap-2">
                                ...
                                <button
                                  ...
                                  title="Add Expense"
                                  onClick={() => handleAddExpense(assignment)}
                                >
                                ...
                                <button
                                  ...
                                  title="Add Payment"
                                  onClick={() => handleAddPayment(assignment)}
                                >
      ...
      <AddExpenseModal
        ...
        assignment={selectedExpenseAssignment}
